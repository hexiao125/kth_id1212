package se.kth.id1212.sockets.hangman.server.integration;
...
public class WordBank {
    ...
    private static final String FILENAME = "src/main/java/se/kth/id1212/sockets/hangman/server/integration/words.txt";
