...
public class GameModel {
    ...
    public Message updateResult() {
        ...
        return new Message(MsgType.RESULT, this.wordHint);
    }
    ...
    private Message gameOver(boolean win) {
        ...
        if (win) {
            this.score++;   
            return new Message(MsgType.GAMEOVER, GAME_WON_MESSAGE + generatedWord);
        } else {
            this.score--;            
            return new Message(MsgType.GAMEOVER, GAME_LOST_MESSAGE + generatedWord);
        }
    }
